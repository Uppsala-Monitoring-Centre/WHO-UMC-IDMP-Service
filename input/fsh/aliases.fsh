...
Alias: $phpid = http://poc.umcterminologies.org/phpid
Alias: $gsid = http://poc.umcterminologies.org/gsid

// ====== extensions ====
Alias: $parent-phpid-extension = http://poc.umcterminologies.org/StructureDefinition/parent-phpid
Alias: $pdfCharacteristics-rca-ext = http://poc.umcterminologies.org/StructureDefinition/release-characteristics
Alias: $pdfCharacteristics-isi-ext = http://poc.umcterminologies.org/StructureDefinition/intended-site
Alias: $pdfCharacteristics-bdf-ext = http://poc.umcterminologies.org/StructureDefinition/basic-dose-form
Alias: $pdfCharacteristics-ame-ext = http://poc.umcterminologies.org/StructureDefinition/administration-method
...
Alias: $strengthUnitCodeSystem = http://poc.umcterminologies.org/CodeSystem/strength-unit
Alias: $jurisdictionCodeSystem = http://poc.umcterminologies.org/CodeSystem/jurisdiction
Alias: $phpLevelCodeSystem =  http://poc.umcterminologies.org/CodeSystem/phpid-level
Alias: $taskRequestCodeSystem = http://poc.umcterminologies.org/CodeSystem/task-request-code

Alias: $substanceNameAuthority = http://hl7.org/fhir/substance-name-authority

Alias: $edqmPdfReleaseChar = http://poc.umcterminologies.org/ValueSet/edqm-rca 
Alias: $edqmPdfBasicDoseForm = http://poc.umcterminologies.org/ValueSet/edqm-bdf 
Alias: $edqmPdfIntendedSite = http://poc.umcterminologies.org/ValueSet/edqm-isi 
Alias: $edqmPdfAdministrationMethod = http://poc.umcterminologies.org/ValueSet/edqm-ame 
Alias: $pharmaceuticalForm = http://poc.umcterminologies.org/ValueSet/pharmaceutical-form 

Alias: $umcProductId = http://poc.umcterminologies.org/umc-product-id
Alias: $phpidlevel4 = http://poc.umcterminologies.org/phpid-level4
...
Alias: $channelType = http://poc.umcterminologies.org/ValueSet/channel-type // TODO: Only in PoC remove after split
...
Alias: $pdfCharacteristics = http://poc.umcterminologies.org/CodeSystem/pdf-characteristics // Används denna? Finns inte eller är struken i Excel
Alias: $drugcode = https://poc.umcterminologies.org/whodrug/CodeSystem/drugcode // Används denna? Finns inte eller är struken i Excel
